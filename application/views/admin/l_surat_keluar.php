	...
	<tbody>
		...
		<tr>
			...
			<td class="ctr">
				...
				<?php } else { ?>
				<div class="btn-group">
					<a href="<?php echo base_URL()?>index.php/admin/surat_keluar_cetak/<?php echo $b->id?>" class="btn btn-info btn-sm" target="_blank" title="Cetak Disposisi"><i class="icon-print icon-white"> </i> Ctk</a>
				</div>
				<?php } ?>
			</td>
		</tr>
